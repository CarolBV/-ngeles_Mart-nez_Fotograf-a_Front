    ...
    <div className='aboutMeContainer'>
      ...
      <div className='aboutMeInfo'>
        <div className='textAbout'>
          <p>
            ¡Hola! soy <strong>Ángeles Martinez</strong>, una apasionada fotógrafa con más de 13 años de experiencia, 
            dedicándome profesionalmente a capturar momentos especiales. Mi especialidad es la fotografía infantil y familiar,
            y encuentro mi mayor inspiración en los exteriores, donde la naturaleza 
            añade un toque mágico a cada sesión. Desde que me convertí en mamá, he aprendido a valorar profundamente el peso de los recuerdos
          y lo rápido que pasa el tiempo. Esta experiencia personal me ha motivado a capturar esos momentos fugaces y convertirlos en recuerdos eternos para otras familias.
          </p>  
        </div>
